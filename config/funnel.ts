...
export const config_baseline: FunnelConfig = {
  screens: [
    {
      id: 'index',
      component: 'LandingV1',
...
// Creating an experimental configuration with slightly different content
export const config_experimental: FunnelConfig = {
  screens: [
    {
      id: 'index',
      component: 'LandingV2',
